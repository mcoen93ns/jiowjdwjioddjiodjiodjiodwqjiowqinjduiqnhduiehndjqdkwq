...
function CheckGithubActions() {
    Write-Host "Checking github actions to see if the pipeline has run successfully"
        ...
        $response = gh api -X GET repos/mcoen93ns/jiowjdwjioddjiodjiodjiodwqjiowqinjduiqnhduiehndjqdkwq/actions/runs
...
Write-Host "Running smoke test for jiowjdwjioddjiodjiodjiodwqjiowqinjduiqnhduiehndjqdkwq"
